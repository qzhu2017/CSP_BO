...
if len(sys.argv) == 2:
    ...
    #train_data = get_data(db_file, des, N_force=5, lists=db_ids, select=True, no_energy=True)
    train_data = get_data(db_file, des, N_force=5, lists=db_ids, select=True)
    #train_data = get_data(db_file, des, N_force=10, lists=db_ids, select=True)
